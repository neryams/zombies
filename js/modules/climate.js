...
exports.options = {
	...
	init: function() {
		...
		this.S.addUpgrades(this,
			{cost: 200,paths:['strain-zombie','strain-reproducer'],name:'Heat Affinity I', onUpgrade: warmAcc, description:'Zombies become stronger in warmth.', gene:{size: 3, shape: 'r', color: 'yellow'}},
			{cost: 200,paths:['strain-zombie','strain-reproducer'],name:'Cold Affinity I', onUpgrade: coldAcc, description:'Zombies become stronger in cold.', gene:{size: 3, shape: 'r', color: 'green'}},
			{cost: 200,paths:['strain-zombie','strain-reproducer'],name:'Water Affinity I', onUpgrade: wetAcc,bg:1, description:'Zombies become stronger in wet conditions.', gene:{size: 3, shape: 'r', color: 'blue'}},
