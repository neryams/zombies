...
exports.options = {
	init: function() {
		...
		this.S.addUpgrades(this,
			{cost: 5000,paths:['strain-reproducer'],name:'Gene Upgrade', onUpgrade: enlargeGrid, description:'Makes gene mutation grid larger. Allows for more complex mutations. <p class="strong">6x6 Mutation Grid</p>'},
